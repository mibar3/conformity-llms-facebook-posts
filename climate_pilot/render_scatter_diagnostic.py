"""
Renders climate_pilot/diagnostic_scatter_chart/posts/*/html/*.html into PNGs, same pattern as
render_climate_html_to_png.py / render_neutral_caption_diagnostic.py -- run on the machine with
a working Chromium binary, not the GPU server. Baseline-only diagnostic (no engagement scales).

Usage:
    python3 climate_pilot/render_scatter_diagnostic.py
...
POSTS_DIR = OUT_DIR / "diagnostic_scatter_chart" / "posts"
